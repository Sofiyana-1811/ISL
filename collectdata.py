...
while True:
    ...
    count = {
             ...
             'r': len(os.listdir(directory+"/1")),
             's': len(os.listdir(directory+"/2")),
             't': len(os.listdir(directory+"/3")),
             'u': len(os.listdir(directory+"/4")),
             'v': len(os.listdir(directory+"/5")),
             'w': len(os.listdir(directory+"/6")),
             'x': len(os.listdir(directory+"/7")),
             'y': len(os.listdir(directory+"/8")),
             'z': len(os.listdir(directory+"/9")),
             }
    ...
    if interrupt & 0xFF == ord('1'):
        cv2.imwrite(directory+'1/'+str(count['r'])+'.png',frame)
    if interrupt & 0xFF == ord('2'):
        cv2.imwrite(directory+'2/'+str(count['s'])+'.png',frame)
    if interrupt & 0xFF == ord('3'):
        cv2.imwrite(directory+'3/'+str(count['t'])+'.png',frame)
    if interrupt & 0xFF == ord('4'):
        cv2.imwrite(directory+'4/'+str(count['u'])+'.png',frame)
    if interrupt & 0xFF == ord('5'):
        cv2.imwrite(directory+'5/'+str(count['v'])+'.png',frame)
    if interrupt & 0xFF == ord('6'):
        cv2.imwrite(directory+'6/'+str(count['w'])+'.png',frame)
    if interrupt & 0xFF == ord('7'):
        cv2.imwrite(directory+'7/'+str(count['x'])+'.png',frame)
    if interrupt & 0xFF == ord('8'):
        cv2.imwrite(directory+'8/'+str(count['y'])+'.png',frame)
    if interrupt & 0xFF == ord('9'):
        cv2.imwrite(directory+'9/'+str(count['z'])+'.png',frame)
